    ...
    return (
        <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10'>
            <div className='grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5'>
                <div className='lg:col-span-3 p-4 bg-white'>
                    <form className='mx-auto pt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8'>
                ...
                <div className='lg:col-span-2 px-4'>
                    <div className="mx-auto pt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
                        <h2 className='text-4xl font-bold text-gray-900 py-2'>Order Summary</h2>
