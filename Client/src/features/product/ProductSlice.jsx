...
export const fetchAllProductsAsync = createAsyncThunk(
  'product/fetchAllPorducts',
  async () => {
    const response = await fetchAllPorducts();
...
export const productSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchAllPorductsByFilterAsync.pending, (state) => {
        state.status = 'loading';
      })
      .addCase(fetchAllPorductsByFilterAsync.fulfilled, (state, action) => {
        state.status = 'idle';
